import SafeQuestionTable from '@/pages/Question/QuestionSet/components/SafeQuestionTable';
import { getSubmitSummaryUsingGET } from '@/services/brarinstorming/questionController';
