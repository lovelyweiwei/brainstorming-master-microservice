  ...
  <div id="addQuestionView">
    ...
    <a-form :model="form" label-align="left">
      ...
      <a-form-item
        ...
        label="难度"
        :rules="[
          // { match: /简单/, message: 'must select one' },
        ]"
      >
        <a-select
      ...
      <a-form-item field="content" label="题目内容">
        <MDEditer :value="form.content" :handle-change="onContentChange" />
      </a-form-item>
      <a-form-item field="answer" label="答案">
        <MDEditer :value="form.answer" :handle-change="onAnswerChange" />
      </a-form-item>
      ...
      >
        ...
        >
          <a-space
            direction="vertical"
            style="min-width: 640px; margin-bottom: 6px"
          >
            <a-form-item
